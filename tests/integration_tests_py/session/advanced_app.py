...
async def session_persistence_test():
    ...
    async with websockets.connect(uri, additional_headers=headers) as websocket:
        ...
        await websocket.send(pack("set_data_indexed_false", "brocan"))
        ...
        await websocket.send(pack("get_data"))
        ...
        await websocket.send(pack("find_by", "brocan"))
        ...
        await websocket.send(pack("set_data_indexed_true", "brocan"))
